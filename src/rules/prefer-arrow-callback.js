                ...
                if (
                    ...
                    if (astUtils.isCallee(maybeCallee)) {
                        if (!bound) {
                            ...
                            retv.isLexicalThis =
                                maybeCallee.parent.arguments.length === 1 && maybeCallee.parent.arguments[0].type === "ThisExpression";
                        }
...
function hasDuplicateParams(paramsList) {
    return (
        paramsList.every(param => param.type === "Identifier") && paramsList.length !== new Set(paramsList.map(param => param.name)).size
    );
}
