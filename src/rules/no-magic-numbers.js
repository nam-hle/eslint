        ...
        schema: [
            {
                ...
                properties: {
                    ...
                    ignore: {
                        type: "array",
                        items: {
                            anyOf: [{ type: "number" }, { type: "string", pattern: "^[+-]?(?:0|[1-9][0-9]*)n$" }]
                        },
                        uniqueItems: true
                    },
                    ignoreArrayIndexes: {
    ...
    create(context) {
        ...
        function isParseIntRadix(fullNumberNode) {
            ...
            return (
                ...
                (astUtils.isSpecificId(parent.callee, "parseInt") || astUtils.isSpecificMemberAccess(parent.callee, "Number", "parseInt"))
            );
        }
