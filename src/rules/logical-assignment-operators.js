...
function isExplicitNullishComparison(expression, scope) {
    ...
    return (
        astUtils.isSameReference(expression.left[leftReference], expression.right[rightReference]) &&
                ...
                AssignmentExpression(assignment) {
                    ...
                    const suggestion = {
                        ...
                        *fix(ruleFixer) {
                            ...
                            const precedence =
                                astUtils.getPrecedence(assignment.right) <= astUtils.getPrecedence({ type: "LogicalExpression", operator });
