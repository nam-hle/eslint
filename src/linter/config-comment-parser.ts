...
const debug = Debug("eslint:config-comment-parser");
...
export = class ConfigCommentParser {
     ...
     */
    parseStringConfig(string: string, comment: string) {
     ...
     */
    parseJsonConfig(string: string, location: any) {
