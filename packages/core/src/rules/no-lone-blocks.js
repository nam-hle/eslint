...
module.exports = {
    ...
    create(context) {
        ...
        function report(node) {
            const messageId =
                node.parent.type === "BlockStatement" || node.parent.type === "StaticBlock" ? "redundantNestedBlock" : "redundantBlock";
            ...
            ruleDef = {
                ...
                "BlockStatement:exit"(node) {
                    if (loneBlocks.length > 0 && loneBlocks[loneBlocks.length - 1] === node) {
                        ...
                        (node.parent.type === "BlockStatement" || node.parent.type === "StaticBlock") &&
