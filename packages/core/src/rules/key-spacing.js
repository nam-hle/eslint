...
module.exports = {
    ...
    create(context) {
        ...
        function isKeyValueProperty(property) {
            return !(
                (property.method || property.shorthand || property.kind !== "init" || property.type !== "Property") // Could be "ExperimentalSpreadProperty" or "SpreadElement"
            );
        }
        ...
        function continuesPropertyGroup(lastMember, candidate) {
            const groupEndLine = lastMember.loc.start.line,
                candidateValueStartLine = (isKeyValueProperty(candidate) ? getFirstTokenAfterColon(candidate.key) : candidate).loc.start
                    .line;
        ...
        function report(property, side, whitespace, expected, mode) {
            ...
            if (
                ((diff && mode === "strict") || (diff < 0 && mode === "minimum") || (diff > 0 && !expected && mode === "minimum")) &&
