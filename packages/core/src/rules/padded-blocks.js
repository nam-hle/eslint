            ...
            if (requirePaddingFor(node)) {
                    ...
                    context.report({
                        ...
                        fix(fixer) {
                            return fixer.replaceTextRange(
                                [tokenBeforeFirst.range[1], firstBlockToken.range[0] - firstBlockToken.loc.start.column],
                                "\n"
                            );
                        },
                ...
                if (blockHasBottomPadding) {
                    context.report({
                        ...
                        fix(fixer) {
                            return fixer.replaceTextRange(
                                [lastBlockToken.range[1], tokenAfterLast.range[0] - tokenAfterLast.loc.start.column],
                                "\n"
                            );
                        }
                    });
