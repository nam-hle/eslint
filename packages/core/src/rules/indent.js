...
module.exports = {
    ...
    create(context) {
        ...
        function isOuterIIFE(node) {
            ...
            return (
                (statement.type === "ExpressionStatement" || statement.type === "VariableDeclaration") &&
        ...
        function addElementListIndent(elements, startToken, endToken, offset) {
            ...
            elements.forEach((element, index) => {
                ...
                if (offset === "first" && tokenInfo.isFirstTokenOfLine(getFirstToken(element))) {
                    ...
                    if (
                        previousElement &&
                        previousElementLastToken.loc.end.line - countTrailingLinebreaks(previousElementLastToken.value) >
        ...
        function addFunctionCallIndent(node) {
            ...
            const offsetAfterToken =
                node.callee.type === "TaggedTemplateExpression" ? sourceCode.getFirstToken(node.callee.quasi) : openingParen;
            ...
            TemplateLiteral(node) {
                node.expressions.forEach((expression, index) => {
                    ...
                    const tokenToAlignFrom =
                        previousQuasi.loc.start.line === previousQuasi.loc.end.line ? sourceCode.getFirstToken(previousQuasi) : null;
            ...
            "Program:exit"() {
                ...
                const precedingTokens = sourceCode.ast.comments.reduce((commentMap, comment) => {
                    ...
                    return commentMap.set(
                        comment,
                        commentMap.has(tokenOrCommentBefore) ? commentMap.get(tokenOrCommentBefore) : tokenOrCommentBefore
                    );
                }, new WeakMap());
