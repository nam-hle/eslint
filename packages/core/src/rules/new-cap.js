        ...
        if (config.newIsCap) {
            listeners.NewExpression = function (node) {
                ...
                if (constructorName) {
                    ...
                    const isAllowed =
                        capitalization !== "lower" || isCapAllowed(newIsCapExceptions, node, constructorName, newIsCapExceptionPattern);
        ...
        if (config.capIsNew) {
            listeners.CallExpression = function (node) {
                ...
                if (calleeName) {
                    ...
                    const isAllowed =
                        capitalization !== "upper" || isCapAllowed(capIsNewExceptions, node, calleeName, capIsNewExceptionPattern);
