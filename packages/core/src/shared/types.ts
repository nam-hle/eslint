...
import { ASTNode, Position, SourceLocation } from "../estree";
...
export type { EnvsMap, GlobalsMap, ConfigArray, ExtractedConfig, GlobalConf, SeverityConf, RuleConf, SeverityString };
...
export type { OverrideConfigData };
...
export type { ScopeManager, ParseResult };
...
export type { DeprecatedRuleInfo };
