 ...
 */
function getRuleOptionsSchema(rule: Rule) {
    if (!rule) {
        return null;
    }
 ...
 */
function validateRuleSeverity(options: RuleConf): SeverityConf {
 ...
 * @returns {void}
 */
function validateRuleSchema(rule: Rule, localOptions: unknown[]) {
 ...
 * @returns {void}
 */
function validateRuleOptions(rule: Rule, ruleId: string, options: RuleConf, source: string | null = null) {
    try {
 ...
 * @returns {void}
 */
function validateEnvironment(environment: object | undefined, source: string, getAdditionalEnv = noop) {
 ...
 * @returns {void}
 */
function validateRules(rulesConfig: Record<string, RuleConf> | undefined, source: string, getAdditionalRule = noop) {
    if (!rulesConfig) {
        return;
    }
 ...
 * @returns {void}
 */
function validateGlobals(globalsConfig: object | undefined, source: string | null = null) {
    if (!globalsConfig) {
        return;
    }
 ...
 * @returns {void}
 */
function validateProcessor(processorName: string | undefined, source: string, getProcessor: (id: string) => Processor) {
 ...
 * @returns {void}
 */
function validateConfigSchema(config: object, source: string) {
 ...
 * @returns {void}
 */
function validateConfigArray(configArray: ConfigArray) {
