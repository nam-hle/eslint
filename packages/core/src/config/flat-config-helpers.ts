 ...
 *      or undefined if not.
 */
function getRuleFromConfig(ruleId: string, config: any) {
 ...
 */
function getRuleOptionsSchema(rule: Rule): Record<string, any> | null {
    if (!rule) {
        return null;
    }
...
export { parseRuleId, getRuleFromConfig, getRuleOptionsSchema };
