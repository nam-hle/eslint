...
const ruleSeverities = new Map<SeverityConf, SeverityNumber>([
    [0, 0],
    ["off", 0],
    [1, 1],
    ["warn", 1],
...
const globalVariablesValues = new Set<GlobalConf | "true" | "false" | null>([
    true,
    "true",
    "writable",
    "writeable",
 ...
 */
function deepMerge(first: Record<string, any> = {}, second: Record<string, any> = {}) {
    /*
 ...
 */
function normalizeRuleOptions(ruleOptions: RuleConf) {
    const finalOptions = Array.isArray(ruleOptions) ? ruleOptions.slice(0) : [ruleOptions];

    finalOptions[0] = ruleSeverities.get(finalOptions[0] as SeverityConf);
    return finalOptions;
}
 ...
 */
function assertIsRuleOptions(value: any) {
 ...
 */
function assertIsRuleSeverity(value: any) {
    const severity = typeof value === "string" ? ruleSeverities.get(value.toLowerCase() as SeverityConf) : ruleSeverities.get(value);
 ...
 */
function assertIsPluginMemberName(value: string) {
 ...
 */
function assertIsObject(value: any) {
 ...
 */
function assertIsObjectOrString(value: any) {
...
/** @type {ObjectPropertySchema} */
const globalsSchema: ObjectPropertySchema = {
    merge: "assign",
...
/** @type {ObjectPropertySchema} */
const parserSchema: ObjectPropertySchema = {
    merge: "replace",
    validate(value) {
...
/** @type {ObjectPropertySchema} */
const pluginsSchema: ObjectPropertySchema = {
    merge(first: Record<string, any> = {}, second: Record<string, any> = {}) {
...
/** @type {ObjectPropertySchema} */
const processorSchema: ObjectPropertySchema = {
    merge: "replace",
    validate(value: any) {
        if (typeof value === "string") {
            assertIsPluginMemberName(value);
...
/** @type {ObjectPropertySchema} */
const rulesSchema: ObjectPropertySchema = {
    merge(first: Record<string, any> = {}, second: Record<string, any> = {}) {
        const result: Record<string, any> = {
            ...first,
            ...second
...
/** @type {ObjectPropertySchema} */
const ecmaVersionSchema: ObjectPropertySchema = {
    merge: "replace",
    validate(value: any) {
...
/** @type {ObjectPropertySchema} */
const sourceTypeSchema: ObjectPropertySchema = {
    merge: "replace",
    validate(value) {
