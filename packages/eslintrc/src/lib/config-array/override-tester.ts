...
type Minimatcher = InstanceType<typeof Minimatch>;

const minimatchOpts: minimatch.IOptions = { dot: true, matchBase: true };
...
interface Pattern {
    includes: Minimatcher[] | null;
    excludes: Minimatcher[] | null;
}
...
class OverrideTester {
     ...
     */
    static create(files: string | string[], excludedFiles: string | string[], basePath: string): OverrideTester | null {
