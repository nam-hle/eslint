...
export namespace ESTree {
    ...
    export type Function_ = FunctionDeclaration | FunctionExpression | ArrowFunctionExpression;
    ...
    export namespace RegExpLiteral {
        export function isInstance(literalNode: Literal): literalNode is RegExpLiteral {
            return "regex" in literalNode;
        }
    }
    ...
    export namespace BigIntLiteral {
        export function isInstance(literalNode: Literal): literalNode is BigIntLiteral {
            return "bigint" in literalNode;
        }
    }
...
export type ASTNode = ESTree.ASTNode;
export type Position = ESTree.Position;
